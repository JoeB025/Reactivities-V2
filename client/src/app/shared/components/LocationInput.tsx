...
const locationUrl = 'https://api.locationiq.com/v1/autocomplete?key=pk.b64e2ce0166e8736ff779f1558aaee01&limit=5&dedupe=1&'; 
...
const fetchSuggestions = useMemo(
  () => debounce(async (query: string) => {
    if (!query || query.length < 3) {
      setSuggestions([])
      return;
      // If the query is empty or less than 3 characters, return/do nothing. 
    }
    setLoading(true);
    try {
